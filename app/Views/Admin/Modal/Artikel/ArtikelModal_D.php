        ...
        <div class="modal-dialog vertical-align-center modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="update_berita">Delete Pelayanan</h5>
                ...
                <div class="modal-body">
                    <!-- Isi Form-->
                    <div class="container">
                        <form action="/pelayanan_delete" method="POST" id="pelayanan_delete_<?= $no ?>">
                            <?= csrf_field(); ?>
                            <input type="text" form="pelayanan_delete_<?= $no ?>" name="id_pelayanan"
                                value="<?= $p['id'] ?>" hidden="true" />
                            <div style="text-align: center;">
                                <h5>Apakah Anda Yakin?</h5>
                            </div>
                            <button type="submit" style="width: 100%;" form="pelayanan_delete_<?= $no ?>"
